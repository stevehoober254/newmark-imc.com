<div id="sidebar" class="c-sidebar c-sidebar-fixed c-sidebar-lg-show">
    ...
    <ul class="c-sidebar-nav">
        ...
        @can('contact_access')
        <li class="c-sidebar-nav-item">
            <a href="{{ route("admin.contacts.index") }}" class="c-sidebar-nav-link {{ request()->is(" admin/contacts")
                || request()->is("admin/contacts/*") ? "c-active" : "" }}">
        ...
        @can('country_access')
        <li class="c-sidebar-nav-item">
            <a href="{{ route("admin.countries.index") }}" class="c-sidebar-nav-link {{ request()->is("
                admin/countries") || request()->is("admin/countries/*") ? "c-active" : "" }}">
        ...
        <li class="c-sidebar-nav-item">
            <a href="{{ route("admin.departments.index") }}" class="c-sidebar-nav-link {{ request()->is("
                admin/departments") || request()->is("admin/departments/*") ? "c-active" : "" }}">
        ...
        @can('office_access')
        <li class="c-sidebar-nav-item">
            <a href="{{ route("admin.offices.index") }}" class="c-sidebar-nav-link {{ request()->is(" admin/offices")
                || request()->is("admin/offices/*") ? "c-active" : "" }}">
        ...
        <li class="c-sidebar-nav-dropdown {{ request()->is(" admin/opportunities*") ? "c-show" : "" }} {{ request()->
            is("admin/personal-history-forms*") ? "c-show" : "" }} {{ request()->is("admin/internship-forms*") ?
            "c-show" : "" }} {{ request()->is("admin/attachment-forms*") ? "c-show" : "" }}">
            ...
            <ul class="c-sidebar-nav-dropdown-items">
                ...
                <li class="c-sidebar-nav-item">
                    <a href="{{ route("admin.opportunities.index") }}" class="c-sidebar-nav-link {{ request()->is("
                        admin/opportunities") || request()->is("admin/opportunities/*") ? "c-active" : "" }}">
                ...
                <li class="c-sidebar-nav-item">
                    <a href="{{ route("admin.personal-history-forms.index") }}"
                        class="c-sidebar-nav-link {{ request()->is(" admin/personal-history-forms") ||
                        request()->is("admin/personal-history-forms/*") ? "c-active" : "" }}">
                ...
                @can('personal_history_form_access')
                <li class="c-sidebar-nav-item">
                    <a href="{{ route("admin.internship-forms.index") }}" class="c-sidebar-nav-link {{ request()->is("
                        admin/internship-forms") || request()->is("admin/internship-forms/*") ? "c-active" : "" }}">
                ...
                @can('personal_history_form_access')
                <li class="c-sidebar-nav-item">
                    <a href="{{ route("admin.attachment-forms.index") }}" class="c-sidebar-nav-link {{ request()->is("
                        admin/attachment-forms") || request()->is("admin/attachment-forms/*") ? "c-active" : "" }}">
        ...
        <li class="c-sidebar-nav-dropdown {{ request()->is(" admin/videos*") ? "c-show" : "" }}">
            ...
            <ul class="c-sidebar-nav-dropdown-items">
                @can('video_access')
                <li class="c-sidebar-nav-item">
                    <a href="{{ route("admin.videos.index") }}" class="c-sidebar-nav-link {{ request()->is("
                        admin/videos") || request()->is("admin/videos/*") ? "c-active" : "" }}">
        ...
        @endcan
        @can('general_access')
        <li class="c-sidebar-nav-dropdown {{ request()->is(" admin/clients*") ? "c-show" : "" }} {{ request()->
            is("admin/newsletter-subscribers*") ? "c-show" : "" }} {{ request()->is("admin/sectors*") ? "c-show" : "" }}
            {{ request()->is("admin/galleries*") ? "c-show" : "" }} {{ request()->is("admin/testimonials*") ? "c-show" :
            "" }}">
            <a class="c-sidebar-nav-dropdown-toggle" href="#">
            ...
            <ul class="c-sidebar-nav-dropdown-items">
                ...
                <li class="c-sidebar-nav-item">
                    <a href="{{ route("admin.newsletter-subscribers.index") }}"
                        class="c-sidebar-nav-link {{ request()->is(" admin/newsletter-subscribers") ||
                        request()->is("admin/newsletter-subscribers/*") ? "c-active" : "" }}">
                ...
                @can('sector_access')
                <li class="c-sidebar-nav-item">
                    <a href="{{ route("admin.sectors.index") }}" class="c-sidebar-nav-link {{ request()->is("
                        admin/sectors") || request()->is("admin/sectors/*") ? "c-active" : "" }}">
                ...
                @can('gallery_access')
                <li class="c-sidebar-nav-item">
                    <a href="{{ route("admin.galleries.index") }}" class="c-sidebar-nav-link {{ request()->is("
                        admin/galleries") || request()->is("admin/galleries/*") ? "c-active" : "" }}">
                ...
                <li class="c-sidebar-nav-item">
                    <a href="{{ route("admin.testimonials.index") }}" class="c-sidebar-nav-link {{ request()->is("
                        admin/testimonials") || request()->is("admin/testimonials/*") ? "c-active" : "" }}">
                        <i class="fa-fw fas fa-cogs c-sidebar-nav-icon">
        ...
        <li class="c-sidebar-nav-item">
            <a href="{{ route("admin.our-expertises.index") }}" class="c-sidebar-nav-link {{ request()->is("
                admin/our-expertises") || request()->is("admin/our-expertises/*") ? "c-active" : "" }}">
        ...
        @can('insight_access')
        <li class="c-sidebar-nav-item">
            <a href="{{ route("admin.insights.index") }}" class="c-sidebar-nav-link {{ request()->is(" admin/insights")
                || request()->is("admin/insights/*") ? "c-active" : "" }}">
