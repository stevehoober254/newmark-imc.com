    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.opportunities.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('expertise_area') ? 'is-invalid' : '' }}" name="expertise_area_id" id="expertise_area_id" required>
                    @foreach($expertise_areas as $id => $entry)
                        <option value="{{ $id }}" {{ old('expertise_area_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('reporting_to') ? 'is-invalid' : '' }}" type="text" name="reporting_to" id="reporting_to" value="{{ old('reporting_to', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('job_purpose') ? 'is-invalid' : '' }}" type="text" name="job_purpose" id="job_purpose" value="{{ old('job_purpose', '') }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('key_responsibility') ? 'is-invalid' : '' }}" name="key_responsibility" id="key_responsibility">{!! old('key_responsibility') !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('qualification') ? 'is-invalid' : '' }}" name="qualification" id="qualification">{!! old('qualification') !!}</textarea>
