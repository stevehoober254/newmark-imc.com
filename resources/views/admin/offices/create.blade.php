    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.offices.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('office_phone') ? 'is-invalid' : '' }}" type="text" name="office_phone" id="office_phone" value="{{ old('office_phone', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('office_email') ? 'is-invalid' : '' }}" type="email" name="office_email" id="office_email" value="{{ old('office_email') }}">
