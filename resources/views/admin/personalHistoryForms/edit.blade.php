    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.personal-history-forms.update", [$personalHistoryForm->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('date_of_graduation') ? 'is-invalid' : '' }}" type="text" name="date_of_graduation" id="date_of_graduation" value="{{ old('date_of_graduation', $personalHistoryForm->date_of_graduation) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('skills') ? 'is-invalid' : '' }}" type="text" name="skills" id="skills" value="{{ old('skills', $personalHistoryForm->skills) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('type_of_engagement') ? 'is-invalid' : '' }}" type="text" name="type_of_engagement" id="type_of_engagement" value="{{ old('type_of_engagement', $personalHistoryForm->type_of_engagement) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('preferred_workstation') ? 'is-invalid' : '' }}" type="text" name="preferred_workstation" id="preferred_workstation" value="{{ old('preferred_workstation', $personalHistoryForm->preferred_workstation) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('salary_expectations') ? 'is-invalid' : '' }}" type="number" name="salary_expectations" id="salary_expectations" value="{{ old('salary_expectations', $personalHistoryForm->salary_expectations) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('why_would_you_like_to_join_our_team') ? 'is-invalid' : '' }}" name="why_would_you_like_to_join_our_team" id="why_would_you_like_to_join_our_team">{{ old('why_would_you_like_to_join_our_team', $personalHistoryForm->why_would_you_like_to_join_our_team) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('facebook_url') ? 'is-invalid' : '' }}" name="facebook_url" id="facebook_url">{{ old('facebook_url', $personalHistoryForm->facebook_url) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('twitter_url') ? 'is-invalid' : '' }}" name="twitter_url" id="twitter_url">{{ old('twitter_url', $personalHistoryForm->twitter_url) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('linked_in_url') ? 'is-invalid' : '' }}" name="linked_in_url" id="linked_in_url">{{ old('linked_in_url', $personalHistoryForm->linked_in_url) }}</textarea>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('do_you_have_personal_website') ? 'is-invalid' : '' }}" name="do_you_have_personal_website" id="do_you_have_personal_website">
                    ...
                    @foreach(App\Models\PersonalHistoryForm::DO_YOU_HAVE_PERSONAL_WEBSITE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('do_you_have_personal_website', $personalHistoryForm->do_you_have_personal_website) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('portfolio_url') ? 'is-invalid' : '' }}" name="portfolio_url" id="portfolio_url">{{ old('portfolio_url', $personalHistoryForm->portfolio_url) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('other_links_works') ? 'is-invalid' : '' }}" name="other_links_works" id="other_links_works">{{ old('other_links_works', $personalHistoryForm->other_links_works) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('organization_one') ? 'is-invalid' : '' }}" type="text" name="organization_one" id="organization_one" value="{{ old('organization_one', $personalHistoryForm->organization_one) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('number_of_employees_supervised_one') ? 'is-invalid' : '' }}" type="number" name="number_of_employees_supervised_one" id="number_of_employees_supervised_one" value="{{ old('number_of_employees_supervised_one', $personalHistoryForm->number_of_employees_supervised_one) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('start_date_one') ? 'is-invalid' : '' }}" type="text" name="start_date_one" id="start_date_one" value="{{ old('start_date_one', $personalHistoryForm->start_date_one) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('end_date_one') ? 'is-invalid' : '' }}" type="text" name="end_date_one" id="end_date_one" value="{{ old('end_date_one', $personalHistoryForm->end_date_one) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('description_of_the_roles_and_responsibilities_one') ? 'is-invalid' : '' }}" name="description_of_the_roles_and_responsibilities_one" id="description_of_the_roles_and_responsibilities_one">{{ old('description_of_the_roles_and_responsibilities_one', $personalHistoryForm->description_of_the_roles_and_responsibilities_one) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('reason_for_leaving_one') ? 'is-invalid' : '' }}" name="reason_for_leaving_one" id="reason_for_leaving_one">{{ old('reason_for_leaving_one', $personalHistoryForm->reason_for_leaving_one) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('organization_two') ? 'is-invalid' : '' }}" type="text" name="organization_two" id="organization_two" value="{{ old('organization_two', $personalHistoryForm->organization_two) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('number_of_employees_supervised_two') ? 'is-invalid' : '' }}" type="number" name="number_of_employees_supervised_two" id="number_of_employees_supervised_two" value="{{ old('number_of_employees_supervised_two', $personalHistoryForm->number_of_employees_supervised_two) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('start_date_two') ? 'is-invalid' : '' }}" type="text" name="start_date_two" id="start_date_two" value="{{ old('start_date_two', $personalHistoryForm->start_date_two) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('end_date_two') ? 'is-invalid' : '' }}" type="text" name="end_date_two" id="end_date_two" value="{{ old('end_date_two', $personalHistoryForm->end_date_two) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('description_of_the_roles_and_responsibilities_two') ? 'is-invalid' : '' }}" name="description_of_the_roles_and_responsibilities_two" id="description_of_the_roles_and_responsibilities_two">{{ old('description_of_the_roles_and_responsibilities_two', $personalHistoryForm->description_of_the_roles_and_responsibilities_two) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('reason_for_leaving_two') ? 'is-invalid' : '' }}" name="reason_for_leaving_two" id="reason_for_leaving_two">{{ old('reason_for_leaving_two', $personalHistoryForm->reason_for_leaving_two) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('organization_three') ? 'is-invalid' : '' }}" type="text" name="organization_three" id="organization_three" value="{{ old('organization_three', $personalHistoryForm->organization_three) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('number_of_employees_supervised_three') ? 'is-invalid' : '' }}" type="number" name="number_of_employees_supervised_three" id="number_of_employees_supervised_three" value="{{ old('number_of_employees_supervised_three', $personalHistoryForm->number_of_employees_supervised_three) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('start_date_three') ? 'is-invalid' : '' }}" type="text" name="start_date_three" id="start_date_three" value="{{ old('start_date_three', $personalHistoryForm->start_date_three) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('end_date_three') ? 'is-invalid' : '' }}" type="text" name="end_date_three" id="end_date_three" value="{{ old('end_date_three', $personalHistoryForm->end_date_three) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('description_of_the_roles_and_responsibilities_three') ? 'is-invalid' : '' }}" name="description_of_the_roles_and_responsibilities_three" id="description_of_the_roles_and_responsibilities_three">{{ old('description_of_the_roles_and_responsibilities_three', $personalHistoryForm->description_of_the_roles_and_responsibilities_three) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('reason_for_leaving_three') ? 'is-invalid' : '' }}" name="reason_for_leaving_three" id="reason_for_leaving_three">{{ old('reason_for_leaving_three', $personalHistoryForm->reason_for_leaving_three) }}</textarea>
