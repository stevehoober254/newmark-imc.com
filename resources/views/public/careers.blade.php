                        ...
                        <div class="constrained">
                            <div class="right case-study-text">
                                <div class="case-study-text__inner padding-top-bottom">
                                    ...
                                    <p class="text-white">
                                        Have interest in joining our team? We offer both internship opportunities and
                                        attachment programs for students.
                                        Please complete the appropriate form honestly, answering all sections fully. By
                                        filling this form, you signify that
                                        you consent to the use of this data according to our data Protection and Privacy
                                        Policy.
                                    </p>
                                    <div class="d-flex flex-column flex-md-row gap-2">
                                        <a href="{{ route('internship.form') }}"
                                            class="btn btn-secondary text-white border-white">Apply for Internship <i
                                                class="fa fa-arrow-right"></i></a>
                                        <a href="{{ route('attachment.form') }}"
                                            class="btn btn-secondary-outline text-white border-white">Apply for
                                            Attachment <i class="fa fa-arrow-right"></i></a>
                                    </div>
                                    <div class="mt-3">
                                        <h1 class="feature-box-title">Apply for other roles</h1>
                                        <a href="{{ route('personal.historyform') }}"
                                            class="btn btn-secondary-outline text-white border-white">Fill Personal History Form <i
                                                class="fa fa-arrow-right"></i></a>
                                    </div>
                                </div>
                            </div>
