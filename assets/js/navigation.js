  ...
  $.navigation = function (element, options) {
    ...
    var fixSubmenuRightPosition = function () {
      if (windowWidth() > plugin.settings.mobileBreakpoint) {
        ...
        $(element)
          ...
          .each(function () {
            if (
              $(this).parent().position().left + $(this).outerWidth() >
              navWidth
            ) {
              $(this).css("right", 0);
            } else {
    ...
    var portraitMode = function () {
      ...
      if (plugin.settings.visibleSubmenusOnMobile) {
        ...
        if (
          plugin.settings.submenuIndicator &&
          plugin.settings.submenuIndicatorTrigger
        ) {
          $(element)
            .find(".submenu-indicator")
            .on(clickTouchEvents, function (e) {
              ...
              if (
                $(this).parent("a").siblings(".nav-submenu").css("display") ==
                "none"
              ) {
            ...
            .each(function () {
              if ($(this).siblings(".nav-submenu").length > 0) {
                $(this).on(clickTouchEvents, function (e) {
                  ...
                  if (
                    $(this).siblings(".nav-submenu").css("display") == "none"
                  ) {
                    $(this)
