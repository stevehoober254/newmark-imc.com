    ...
    public function personalHistoryFormStepPost(Request $request, $slug, $step)
    {
        ...
        if ($step == 2) {
            ...
            $request->validate([
                ...
                'organization_two' => 'required',
                'number_of_employees_supervised_two' => 'required|integer',
                'start_date_two' => 'required|date',
                'end_date_two' => 'required|date',
                'description_of_the_roles_and_responsibilities_two' => 'required',
                'reason_for_leaving_two' => 'required',
                'organization_three' => 'required',
                'number_of_employees_supervised_three' => 'required|integer',
                'start_date_three' => 'required|date',
                'end_date_three' => 'required|date',
                'description_of_the_roles_and_responsibilities_three' => 'required',
                'reason_for_leaving_three' => 'required',
            ]);
            $phs->update([
