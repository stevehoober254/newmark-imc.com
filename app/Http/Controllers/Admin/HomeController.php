...
class HomeController
{
    public function index()
    {
        ...
        $settings4 = [
            'chart_title'           => 'Our Expertise',
            'chart_type'            => 'number_block',
            'report_type'           => 'group_by_date',
            'model'                 => 'App\Models\OurExpertise',
            'group_by_field'        => 'created_at',
            'group_by_period'       => 'day',
            'aggregate_function'    => 'count',
            'filter_field'          => 'created_at',
        ...
        $settings6 = [
            'chart_title'           => 'Latest Personal History Form Data',
            'chart_type'            => 'latest_entries',
            'report_type'           => 'group_by_date',
            'model'                 => 'App\Models\PersonalHistoryForm',
            'group_by_field'        => 'date_of_graduation',
            'group_by_period'       => 'day',
            'aggregate_function'    => 'count',
            'filter_field'          => 'created_at',
            'filter_days'           => '90',
            ...
            'translation_key' => 'personalHistoryForm',
        ];
        ...
        $settings7 = [
            'chart_title'           => 'Latest Job Opportunities',
            'chart_type'            => 'latest_entries',
            'report_type'           => 'group_by_date',
            ...
            'fields'                => [
                'job_title'      => '',
                'expertise_area' => 'title',
                'location'       => 'name',
                'status'         => '',
                'created_at'     => '',
            ],
            'translation_key' => 'opportunity',
        ];
